...
const val CUBE_USER_PHONE = "cube_user_phone"
const val CUBE_USER_EMAIL = "cube_user_email"
...
class SharedPreferencesManager private constructor(val applicationContext: Context) {
    ...
    fun saveCurrentUser(user: ConnectycubeUser) {
        ...
        editor.putString(CUBE_USER_EMAIL, user.email)
        editor.putString(CUBE_USER_PHONE, user.phone)
        editor.apply()
    }
