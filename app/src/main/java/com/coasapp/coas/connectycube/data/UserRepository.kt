...
class UserRepository private constructor(
    ...
    fun getUsersByIdsSync(vararg usersIds: Int): List<User> {
        return userDao.getUsersByIdsSync(*usersIds)
    }

    fun getUsersByIdsPvt(users:List<Int>, userId: Int): List<User> {
        return userDao.getUsersByIdsPvt(users, userId)
    }

   /* fun getUsersByIdsPvt(vararg usersIds: Int, duserId: Int): List<User> {
        return userDao.getUsersByIdsPvt(*usersIds, duserId)
    }*/
    companion object {
