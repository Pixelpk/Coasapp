...
internal class DialogOccupantsAdapter(
    ...
    public var itemsNew: List<ConnectycubeUser> = mutableListOf()


    public var chatDialog: ConnectycubeChatDialog? = null;
    ...
    class DialogOccupantViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        fun bind(
            ...
            if (isCurrentUser()) {
                ...
                txtLastActivity.text =
                        getPrettyLastActivityDate(activityContext, connectycubeUser.lastRequestAt
                                ?: Date())
            }
            ...
            if (connectycubeChatDialog!!.isPrivate) {
