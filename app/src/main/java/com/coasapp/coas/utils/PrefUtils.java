...
public class PrefUtils {
    ...
    public static String getAppId(Context context) {
        return getSharedPreferences(context).getString(PREF_KEY_APP_ID, ApplozicSampleApplication.APP_ID1);
    }
    ...
    public static void setFirstLogin(Context context, boolean userId) {
        SharedPreferences.Editor editor = getSharedPreferences(context).edit();
        editor.putBoolean("SendBird1stLogin", userId).apply();
    }

    public static boolean getFirstLogin(Context context) {
        return getSharedPreferences(context).getBoolean("SendBird1stLogin", true);
    }
