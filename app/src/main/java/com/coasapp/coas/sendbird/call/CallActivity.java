...
import com.coasapp.coas.sendbird.BaseApplication;
import com.coasapp.coas.sendbird.utils.AuthenticationUtils;
import com.coasapp.coas.sendbird.utils.BroadcastUtils;
import com.coasapp.coas.sendbird.utils.EndResultUtils;
import com.coasapp.coas.sendbird.utils.UserInfoUtils;
...
public abstract class CallActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == android.R.id.home) {
            Intent intent = new Intent(CallActivity.this, COASHomeActivity.class);
