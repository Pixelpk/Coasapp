package com.coasapp.coas.sendbird.call;
...
public class CallService extends Service {
    ...
    class CallBinder extends Binder {
        com.coasapp.coas.sendbird.call.CallService getService() {
            return com.coasapp.coas.sendbird.call.CallService.this;
        }
    }
    ...
    public IBinder onBind(Intent intent) {
        Log.i("callbinder", "[CallService] onBind()");
        return mBinder;
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.i("callservicestart", "[CallService] onStartCommand()");
    ...
    public void onTaskRemoved(Intent rootIntent) {
        ...
        Log.i("callserviceremoved", "[CallService] onTaskRemoved()");
    ...
    private Notification getNotification(@NonNull ServiceData serviceData) {
        ...
        builder.setContentTitle(serviceData.remoteNicknameOrUserId)
                ...
                .setSmallIcon(R.mipmap.ic_launcher_coas_round)
                .setLargeIcon(BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.ic_launcher_coas_round))
    ...
    public static void dial(Context context, String doDialWithCalleeId, boolean isVideoCall) {
        ...
        if (SendBirdCall.getOngoingCallCount() > 0) {
            ...
            Log.i("callservicedialoncall", "[CallService] dial() => SendBirdCall.getOngoingCallCount(): " + SendBirdCall.getOngoingCallCount());
            return;
        }

        Log.i("callservicedial", "[CallService] dial()");
    ...
    public static void onRinging(Context context, @NonNull DirectCall call) {
        Log.i("callserviceringing", "[CallService] onRinging()");

        ServiceData serviceData = new ServiceData();
        serviceData.isHeadsUpNotification = true;
        serviceData.remoteNicknameOrUserId = com.coasapp.coas.sendbird.utils.UserInfoUtils.getNicknameOrUserId(call.getRemoteUser());
    ...
    private static void startService(Context context, ServiceData serviceData) {
        Log.i("startservice", "[CallService] startService()");

        if (context != null) {
            Intent intent = new Intent(context, com.coasapp.coas.sendbird.call.CallService.class);
    ...
    public static void stopService(Context context) {
        Log.i("callservicestop", "[CallService] stopService()");
    ...
    public void updateNotification(@NonNull ServiceData serviceData) {
        Log.i("alltags", "[CallService] updateNotification(isHeadsUpNotification: " + serviceData.isHeadsUpNotification + ", remoteNicknameOrUserId: " + serviceData.remoteNicknameOrUserId
