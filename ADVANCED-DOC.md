...
```
import com.mobicomkit.api.people.ChannelInfo;
import com.mobicomkit.channel.service.ChannelService;
```
...
Import
```
  import com.mobicomkit.uiwidgets.async.ApplozicChannelAddMemberTask;
```
...
Import  
```
import com.mobicomkit.uiwidgets.async.ApplozicChannelRemoveMemberTask;
```
...
Import
```
import com.mobicomkit.uiwidgets.async.ApplozicChannelLeaveMember;
```
...
import com.mobicomkit.uiwidgets.async.ApplozicChannelNameUpdateTask;
```
...
##### Open Activity on tap of toolbar in Chat Screen
  ...
  ```
  <meta-data
             android:name="com.mobicomkit.uiwidgets.toolbar.tap.activity"
